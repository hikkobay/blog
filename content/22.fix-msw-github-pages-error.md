...
```
[MSW] Failed to register a Service Worker for scope ('https://hikkobay.github.io/') with script ('https://hikkobay.github.io/mockServiceWorker.js'): Service Worker script does not exist at the given path.
```
